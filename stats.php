...
if ($url == '') {
    ...
    <html class="full" lang="zh">
        ...
        <head>
            ...
            <title>URL统计 - <?php echo $info['name']; ?></title>
                ...
                <div class="container animated fadeIn">
                    ...
                    <div class="row">
                        <div class="col-lg-5 QR colored rounded flex-col">
                            ...
                            <div class="col-lg-12"><img alt="二维码" src="//my.tv.sohu.com/user/a/wvideo/getQRCode.do?width=200&height=200&text=<?php echo $created_link; ?>" class="size center-block"/></div>
                            <hr>
